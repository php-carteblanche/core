...
*/
	 ...
	 * @param misc $results The results of the query execution to cache
	 * @return self $this for method chaining
	 */
	 ...
	 *
	 * @param string $query The query string to search in the cache
	 * @return misc The results cached if so, false otherwise
	 */
...
// ------------------------
	 ...
	 *
	 * @return misc The query result as a single value
	 */
	 ...
	 *
	 * @return misc The query results as array
	 */
